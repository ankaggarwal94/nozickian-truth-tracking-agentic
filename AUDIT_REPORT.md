...
| Ultra-review: evidence substitution resistance | Every strict wrapper binds a versioned claim contract over canonical claim text, explicit scope, artifact referent, importance, and substantive typed method M. Modal wrappers additionally bind the complete false-/true-world case, a reviewer-assigned semantic-equivalence class, a canonical structural fingerprint, and one exact case-bound release-declaration identity. Relabeling or duplicating one identity cannot inflate nearby-world coverage. These identities are threshold-deduplication records, not execution provenance |
| Ultra-review: strict result and method contracts | Live envelopes accept one unambiguous substantive `result` or `content` channel and reject contradictory status/outcome/error aliases; formal result success likewise accepts only its canonical content channel. Promotion reconstructs one exact closed `promotion-method-m-v1` record from declared origin, package/evidence/live/formal/gate/policy/parser identities and rejects missing, malformed, or cross-bound inputs |
...
| Command | Result |
|---|---|
| checked-in `validate_package.py . --self-test` | PASS - 1911/1911 checks, 0 critical or noncritical failures, 82/82 false-world mutations rejected through ordinary completed failures, 13/13 true-world variants retained, and two literal release passes with zero changed files; raw stdout parses directly as one JSON document |
| checked-in basic `validate_package.py .` | PASS - 1748/1748 checks, 0 critical or noncritical failures; raw stdout parses directly as one JSON document |
...
| `run_gate_contract_tests.py` | 166/166 contract cases PASS |
| `run_formal_runner_contract_tests.py` | 215/215 contract cases PASS |
...
- LAST VERIFIED: 2026-07-18; gate contracts 166/166 and strict gate PASS-SCOPED.
...
- LAST VERIFIED: 2026-07-18; formal contracts 215/215.
...
- LAST VERIFIED: 2026-07-18; full self-test 1911/1911 and two-pass replay succeeded with zero changed files.
...
- LAST VERIFIED: 2026-07-18; authoritative 44/44 cases and production baseline 252/252 passed.
...
- LAST VERIFIED: 2026-07-18; the exact workflow model, archive full-self-test command, and nearby false/true worlds passed locally. Hosted execution of the current archive command is pending publication; earlier Actions runs predate it and are not evidence for this invariant.
...
- LAST VERIFIED: 2026-07-18; local current-tree results recorded basic 1748/1748, full 1911/1911, gate 166/166, formal 215/215, regression 166/166, promotion 44/44 with a 252/252 baseline, 82/82 false and 13/13 true worlds.
