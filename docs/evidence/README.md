...
Promotion aggregate result/stdout ledgers are volatile for the same reason. The aggregate suite's expected `43/43` is synthetic contract evidence and does not authenticate a real Claude Code runtime.
