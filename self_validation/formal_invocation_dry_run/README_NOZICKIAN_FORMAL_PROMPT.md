...
- <tmp-v102-final-outputs>/README_NOZICKIAN_REPORT.md
- <tmp-v102-final-outputs>/README_NOZICKIAN_certificate.json
- <tmp-v102-final-outputs>/README_NOZICKIAN_GATE.md
- <tmp-v102-final-outputs>/README_NOZICKIAN_INVOCATION_LEDGER.md
...
9. Run exactly this gate command after writing the certificate:
   python3 <package-root>/skills/nozickian-verify/scripts/ntt_gate.py <tmp-v102-final-outputs>/README_NOZICKIAN_certificate.json --evidence-root <package-root> --strict-evidence --markdown <tmp-v102-final-outputs>/README_NOZICKIAN_GATE.md
...
11. The invocation ledger must include:
    ...
    Gate output: <tmp-v102-final-outputs>/README_NOZICKIAN_GATE.md
    Runtime transcript: <tmp-v102-final-outputs>/README_NOZICKIAN_FORMAL_TRANSCRIPT.stream.jsonl
