...
| audit bundle exists | critical | PASS | "<tmp-v101-final-outputs>" |
...
| live runtime eval result present | critical | FAIL | "<tmp-v101-final-outputs>" |
| at least one formal artifact result present | critical | FAIL | [] |
| promotion certificate present | critical | FAIL | "<tmp-v101-final-outputs>" |
| no stale local path or prior-version tokens in package/bundle evidence | critical | PASS | [] |
| current plugin version is semver | critical | PASS | "1.0.1" |
